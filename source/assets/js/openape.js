(function (window) {
    function defineOpenape() {
        ...
        /** initializeLibrary
         *
         * This function is used get the authorization token for the given username and password on the given server
         *
         *
         * @param  username {String} The username of the user from the mongodb
         *
         * @param  password {String} The password of the user from the mongodb
         *
         * @param serverUrl {String} The url of the host server
         *
         * @return {Object} A JavaScript object with all token information
         */
         ...
         *
         * @param  email {String} The email address of the user to be created
         *
         * @param  password {String} The password of the user to be created
         *
         * @return {Object} Returns the result as a JavaScript object
         */
        ...
        /** getUser
         *
         * This function is used to get user information for the locally saved token
         *
         ...
         * This function is used to get user information for the locally saved token
         *
         * @param userId {String} The id of the user for whom the information should be gotten
         *
         * @return {Object} A JavaScript object with all found user information like username, email and roles
         */
        ...
        /** getUserContext
         *
         * This function is used get the user context for the given id and output type
         *
         * @param  userContextId {String} The stored UserContextId from mongodb
         * @param  outputType {String} The desired output type ("XML" or "JSON")
         *
         * @return {Object} A JavaScript object with all user context information
         */
