...
$("body").append(
    ...
    "   <video id='signLanguageVideoContainter' poster='ASPanel/js/URClight/loading.gif'>" +
...
function setSignLanguageMarker() {
    ...
    if (document.getElementById("edit-field-empf-nger") !== null) {
        let d = document.getElementById("edit-field-empf-nger");
...
$(document).ready(function () {
    ...
    $("body").on("click", "a.urclSignLanguageVideo", function (event) {
        ...
        const slContent = $(event.target).attr('data-sl_content');
        // Get Video container.
        const video = document.getElementById("signLanguageVideoContainter");
        ...
        const requestURL = myURCLightController.createSLVRequest(slSettings);
...
function handleSignLanguageButtons() {
    ...
    const videoLinks = document.querySelectorAll("a.urclSignLanguageVideo");
