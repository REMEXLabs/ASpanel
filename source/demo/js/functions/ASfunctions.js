...
const AS_textSize = (function () {
    ...
    module.set = function (multiplier) {
        ...
        const newTextSize = parseFloat(1 * fontSize2Mulitplier(multiplier)) + 'em';
    ...
    module.reset = function () {
        const newTextSize = parseFloat(1 * getDefaultValue()) + 'em';
        $('body').css('font-size', newTextSize);
    };
...
const AS_lineSpacing = (function () {
     ...
     */
    module.reset = function () {
        const newLineSpacing = getDefaultValue() + 'em';
        $('body').css('line-height', newLineSpacing);
    };
...
const AS_picsupport = (function () {
    ...
    module.activate = function (value) {
        if (value === "picsupport-off") {
            ...
            const matches = value.match(/^picsupport-(.*)$/);
