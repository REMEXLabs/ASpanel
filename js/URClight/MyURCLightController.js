...
var myURCLightController = (function() { 
    ...
    module.createSLVRequest = function (slSettings) {
        ...
        var urlstr_Content = slSettings.Content;
        var urlstr_InterpreterName = "_" + slSettings.InterpreterName;
        var urlstr_InterpreterType = "_" + slSettings.InterpreterType;
        var urlstr_Language = "_" + slSettings.Language;
        
        var str_mimeType = ".webm";
